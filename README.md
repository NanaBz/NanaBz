...
League Scheduler started on the pitch — playing in Academic City's football league and getting frustrated with repetitive, conflicting fixtures. I looked at how professional leagues solve scheduling, found the **Circle Method**, and adapted it with randomized starting positions so reschedules did not always lock the same team in place.

What began as a scheduling fix grew into a broader school football ecosystem — league management, cup competitions, and a custom fantasy football layer built on live match data.
...
| # | Project | What it is |
|---|---------|------------|
| **01** | **[League Scheduler](https://github.com/NanaBz/League-Scheduler)** · [Live](https://league-scheduler-bqav.vercel.app/) | Academic City football scheduling → full league, cup, and fantasy platform using the Circle Method |
| **02** | **AetherQore** | Co-founder & Backend Lead on **aetherOS** — a pharmacy operations platform (React, FastAPI, PostgreSQL) unifying catalogue, inventory, POS, and purchasing; AI copilot features planned |
| **03** | **[Ancora](https://github.com/NanaBz/Ancora)** | Medication tracking with caretaker support and photo verification — bridging reminders and accountability |
| **04** | **[FeastFlow](https://github.com/NanaBz/FeastFlow)** · [Live](https://feastflowdev.netlify.app/) | Classroom canteen challenge turned into a points-based ordering and management system |
| **05** | **[NovaForge](https://github.com/NanaBz/NovaForge)** | Frontend web work on a broader VR/XR training concept — immersive training ideas for industrial, mining, and higher-education contexts |
| **06** | **[Fake News Detector](https://github.com/NanaBz/Fake-News-Detector)** | TF-IDF + Logistic Regression on ISOT news data — and a lesson in data representation, confidence handling, and responsible AI |

📁 **[Portfolio](https://personal-portfolio-seven-rho-35.vercel.app/)** · full project stories and narrative
...
*Currently exploring:* statistics fundamentals · deeper machine learning · data visualization · responsible AI
...
- 🔬 Data Science opportunities and learning-focused roles  
- 🤝 Collaborations at the intersection of data, product thinking, and building  
- 💡 Conversations that start with an interesting problem  
